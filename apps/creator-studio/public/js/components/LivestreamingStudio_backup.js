    ...
    return React.createElement('div', {
        ...
        React.createElement('div', {
            ...
            React.createElement('p', {
                key: 'subtitle'
            }, 'Professionelles Streaming mit OBS Integration & Multistream')
        ]),
        
        // Stream Settings & Device Configuration
        React.createElement('div', {
            key: 'settings-grid',
            style: {
                display: 'grid',
            ...
            React.createElement('div', {
                ...
                React.createElement('div', {
                    ...
                    React.createElement('div', {
                        ...
                        React.createElement('div', {
                            ...
                            React.createElement('button', {
                                key: 'copy-server-btn',
                                onClick: () => copyToClipboard(streamServerUrl),
                                style: {
                                    padding: '8px 12px',
                ...
                showOBSGuide && React.createElement('div', {
                    ...
                    React.createElement('ol', {
                        ...
                        React.createElement('li', { key: 'step1', style: { marginBottom: '8px' } }, 
                            'Öffnen Sie OBS Studio und gehen Sie zu "Einstellungen"'),
                        React.createElement('li', { key: 'step2', style: { marginBottom: '8px' } }, 
                            'Wählen Sie "Stream" im linken Menü'),
                        React.createElement('li', { key: 'step3', style: { marginBottom: '8px' } }, 
                            'Wählen Sie "Benutzerdefiniert..." als Service'),
                        React.createElement('li', { key: 'step4', style: { marginBottom: '8px' } }, 
                            'Kopieren Sie die Server URL oben in das "Server" Feld'),
                        React.createElement('li', { key: 'step5', style: { marginBottom: '8px' } }, 
                            'Kopieren Sie den Stream Key in das "Stream-Schlüssel" Feld'),
                        React.createElement('li', { key: 'step6', style: { marginBottom: '8px' } }, 
                            'Klicken Sie "OK" und dann "Streaming starten"'),
                        React.createElement('li', { key: 'step7' }, 
                            'Ihr Stream sollte nun in der Vorschau unten erscheinen!')
                    ])
                ])
            ])
        ]),
        
        // Stream Preview & Multistream
        React.createElement('div', {
            key: 'preview-multistream',
            style: {
                display: 'grid',
            ...
            React.createElement('div', {
                ...
                React.createElement('div', {
                    ...
                    React.createElement('div', {
                        ...
                        React.createElement('button', {
                            key: 'preview-mode-camera',
                            onClick: () => setPreviewMode('camera'),
                            style: {
                                padding: '4px 8px',
                                background: previewMode === 'camera' ? 'var(--prism-purple)' : 'var(--prism-gray-700)',
                                color: 'white',
                                border: 'none',
                                borderRadius: '4px',
                                fontSize: '0.75rem',
                        ...
                        React.createElement('button', {
                            key: 'preview-mode-screen',
                            onClick: () => setPreviewMode('screen'),
                            style: {
                                padding: '4px 8px',
                                background: previewMode === 'screen' ? 'var(--prism-purple)' : 'var(--prism-gray-700)',
                                color: 'white',
                                border: 'none',
                                borderRadius: '4px',
                                fontSize: '0.75rem',
                ...
                React.createElement('div', {
                    ...
                    !streamSettings.isLive ? React.createElement('button', {
                        key: 'start-stream',
                        ...
                        React.createElement('span', { key: 'icon' }, '🔴'),
                        React.createElement('span', { key: 'text' }, 'Stream Starten')
                    ]) : React.createElement('button', {
                        key: 'stop-stream',
            ...
            React.createElement('div', {
                ...
                React.createElement('h3', {
                    ...
                    React.createElement('span', { key: 'icon' }, '🌐'),
                    React.createElement('span', { key: 'text' }, 'Multistreaming')
                ]),
                
                React.createElement('p', {
                    key: 'multistream-desc',
                    style: {
                        color: 'var(--prism-gray-400)',
                        fontSize: 'var(--prism-text-sm)',
                        marginBottom: 'var(--prism-space-md)',
                ...
                }, 'Streamen Sie gleichzeitig auf mehrere Plattformen. Fügen Sie Ihre Stream-Keys hinzu:'),
                ...
                React.createElement('div', {
                    ...
                    React.createElement('div', {
                        ...
                        style: {
                            ...
                            padding: 'var(--prism-space-md)',
                            borderRadius: '8px',
                            border: platform.enabled ? '1px solid var(--prism-green)' : '1px solid var(--prism-gray-700)'
                        }
                    }, [
                        React.createElement('div', {
                            key: 'platform-header',
                            ...
                            React.createElement('button', {
                                ...
                                style: {
                                    padding: '4px 8px',
                                    background: platform.enabled ? 'var(--prism-green)' : 'var(--prism-gray-600)',
                                    color: 'white',
                                    border: 'none',
                                    borderRadius: '4px',
                                    fontSize: '0.75rem',
                        ...
                        platform.enabled && React.createElement('div', {
                            ...
                            React.createElement('input', {
                                key: 'stream-key',
                                type: 'password',
                                placeholder: 'Stream Key eingeben...',
